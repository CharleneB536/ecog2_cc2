...
```
Dans ce tableau, on peut observer l'estimation des abondances de chaque phylas. Cela confirme les résultats précédents.
...
Sur ce graphique représentant la pCoA, les saisons sont représentées en triangles (septembre, été) et en rond (mars, hiver). La profondeur d'échantillonnage est représentée par trois couleurs : surface (bleu), median (vert) et fond (rouge).   
