...
rank_names(ps)
```
L’objet ps possède comme paramètres : “Kingdom” “Phylum” “Class” “Order” “Family” “Genus” “Species”


```{r}
table(tax_table(ps)[, "Phylum"], exclude = NULL)
```
Ce tableau représente les phylla et leur abondances de l'objet ps. On peut constater que les Proteobacteria (799) sont les plus abondantes suivis des Bacteroidota (239).
